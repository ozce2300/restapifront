...
async function getData() {
    ...
    data.forEach((element)=>{
        ...
        article.innerHTML = `<p> <strong>F\xf6retagsnamn: </strong>${element.companyname}<br> 
...
if (form) form.addEventListener("submit", function(event) {
    ...
    if (jobtitle === "") document.getElementById("container-error").innerHTML += `<li>Skriv in jobbtitel</li><br>`;
